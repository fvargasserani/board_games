...
class BoardGamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create board_game" do
    assert_difference('BoardGame.count') do
      post board_games_url, params: { board_game: { name: @board_game.name, rules: @board_game.rules } }
    end
  ...
  test "should update board_game" do
    patch board_game_url(@board_game), params: { board_game: { name: @board_game.name, rules: @board_game.rules } }
